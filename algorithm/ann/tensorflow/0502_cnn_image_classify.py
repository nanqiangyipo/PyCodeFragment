...
weights = {
    ...
    'wd1': tf.Variable(tf.random_normal([int(np.ceil(height/8)*np.ceil(width/8)*128), fc1])),
...
with tf.Session() as sess:
    ...
    data = Traindata(data_path=r'/home/xinye/workingdirectory/PyCodeFragment/data/resized_animal'
                     ,splitline=0.99)
    ...
    while True:
        ...
        if step % display_step == 0:
            ...
            print("%dTestingAccuracy:"%step, sess.run(accuracy, feed_dict={x: testdata[0],y: testdata[1], keep_prob: 1.}))
