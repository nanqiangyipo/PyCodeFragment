...
weights = {
    ...
    'wd1': tf.Variable(tf.random_normal([int(np.ceil(height/8)*np.ceil(width/8)*32), fc1])),
...
with tf.Session() as sess:
    ...
    data = Traindata(data_path=r'/home/xinye/workingdirectory/PyCodeFragment/data/resized_animal',splitline=0.97)
